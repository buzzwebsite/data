  ...
  function init() {
    var mysvg = document.getElementById("svg_id");
    if (window.innerWidth>1000){
      computer_flag = 1;
      mysvg.setAttribute("height",400);
      document.getElementById("link_id").href = "https://raw.githack.com/buzzwebsite/data/master/RankHistory_src/stylesheet_computer.css";
    }
    ...
    xmlhttp.onreadystatechange=function()
    {
      ...
      {
        text_data = xmlhttp.responseText;
        data = d3.csvParse(text_data);
      }
      draw();
  ...
  function draw() {
    ...
    function redraw() {
      ...
      barEnter
        ...
        .attr("fill-opacity", 0)
        .attr("height", bar_height) //手機板->5 garrett computer_flag=1->26
        .attr("y", 50)
      ...
      if (config.showLabel == true) {
        ...
        barEnter
          ...
          .attr("y", yLabel_size) //手機板->5 garrett computer_flag=1->20
      ...
      if (!long) {
        ...
        barEnter
          ...
          .attr("y", yValue_height);//手機板->5 garrett computer_flag=1->22
      }
      var barUpdate = bar
        .transition("2")
        .duration(2990 * interval_time)
    ...
    var inter = setInterval(function next() {
      ...
      if (p) {
        ...
        date_text.innerHTML = dateLabel.text();
        p = 0;
      }
